...
Ətraflı məlumat üçün [Penetration Testing](./penetration-testing.md) məqaləsində Rules of Engagement, authorization letter, PTES, reporting və hüquqi məsələlərə baxın.
...
Actor kateqoriyaları, naming convention və ATT&CK qrupları üçün [Threat Actors and Threat Intelligence](./threat-actors-and-intel.md) məqaləsinə baxın.
...
- **OWASP WSTG** — application testing guidance; [OWASP Top 10](./owasp-top-10.md) ilə birlikdə istifadə olunur.
...
Ətraflı izah üçün [Penetration Testing](./penetration-testing.md) və [Threat Actors and Threat Intelligence](./threat-actors-and-intel.md) məqalələrinə keçin.
...
[Footprinting and Reconnaissance](./osint-basics.md) ilə davam edin, sonra sonrakı CEH modulları üçün networking foundations mövzularını oxuyun. Test sərhədləri və engagement workflow üçün [Penetration Testing](./penetration-testing.md) məqaləsinə qayıdın.
