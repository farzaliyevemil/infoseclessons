...
Bu layin esas xususiyyeti **erisim sahesidir**: cerciv yalniz qurulduyu link uzerinde keceriidir. Paket marsrutlasdiricidan kecdiyi an, L2 basligi soyulur ve yeni MAC unvanlari ile yeniden qurulur. Uzaq serverin MAC-ini hec vaxt "gormurusunuz" — yalniz default gateway-in MAC-ini. **Burada xarab olanlar:** qosulmamis kabeller, olu SFP-ler, ARP zeherlemesi, MAC dasmasi, dupleks uygunsuzluqlari, hele de yanlis VLAN-da olan komutator portu. Detal ucun [Ethernet ve ARP](./ethernet-and-arp.md)-a baxin.
