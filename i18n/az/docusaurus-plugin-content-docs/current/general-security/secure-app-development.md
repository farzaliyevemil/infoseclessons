...
Çapraz istinadlar: hər pipeline-ın əsaslandığı identitet təməlləri üçün [./aaa-non-repudiation.md](./aaa-non-repudiation.md); daha geniş zəiflik dövrü üçün [./vulnerability-management.md](./vulnerability-management.md); bu təcrübələrin nümunə etdiyi nəzarətlər kataloqu üçün [./security-controls.md](./security-controls.md).
