    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          {from: '/general-security/open-source', to: '/general-security/security-tools'},
          {from: '/general-security/open-source-identity-access-secrets', to: '/general-security/security-tools'},
          {from: '/general-security/open-source-monitoring-and-detection', to: '/general-security/security-tools'},
          {from: '/general-security/open-source-network-security-tools', to: '/general-security/security-tools'},
        ],
      },
    ],
    [
